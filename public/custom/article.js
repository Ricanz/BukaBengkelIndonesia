		...
		table.DataTable({
			...
			columnDefs: [
				...
				},
				{
                    ...
                    class: 'text-left',
                    render: function (data, type, full, meta) {
                        return '<a href="/master/article/edit/'+full.id+'">'+data+'</a>'
                    }
				},
				{
					targets: -1,
...
{
    $('#confirmDelete').attr('href', '/master/article/destroy/' + id);
}
