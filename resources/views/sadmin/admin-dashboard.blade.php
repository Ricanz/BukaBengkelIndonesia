                            ...
                            <div class="row row-paddingless">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bolder">{{ $total_bengkel }}</div>
                                            <div class="font-size-sm text-muted font-weight-bold">Total Bengkel
                                            </div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                            ...
                                            @foreach ($checking as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <span
                                                            class="text-muted font-weight-bold">{{ $item->checking_type }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span
                                                            class="text-muted font-weight-bold">{{ $item->employee->fullname }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span
                                                            class="text-muted font-weight-bold">{{ $item->advisor->name }}</span>
                                                    </td>
                                                    <td class="text-start pr-0">
                                                        <span
                                                            class="text-muted font-weight-bold">{{ $item->client->title }}</span>
                                                    </td>
                                                    <td class="text-start pr-0">
