                            ...
                            <div class="row row-paddingless mt-5 mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bolder">{{ $total_standart_checking }}</div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bolder">{{ $total_complete_checking }}</div>
                                    ...
                                    <div class="d-flex align-items-center mr-2">
                                        <span class="symbol-label">
                                            <img src="{{ asset($employee->client->image) }}"
                                                class="align-self-center" alt="" style="height: 200px; width: auto"/>
                                        </span>
                                    </div>
                                </div>
                                <!--end::Item-->
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="pl-0 py-4">
                                                    <div class="symbol symbol-50 symbol-light">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('tadmin/media/svg/misc/003-puzzle.svg') }}"
                                            ...
                                            <tr>
                                                <td class="pl-0 py-4">
                                                    <div class="symbol symbol-50 symbol-light">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('tadmin/media/svg/misc/005-bebo.svg') }}"
                                                                class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="pl-0 py-4">
                                                    <div class="symbol symbol-50 symbol-light">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('tadmin/media/svg/misc/014-kickstarter.svg') }}"
                                                                class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="pl-0 py-4">
                                                    <div class="symbol symbol-50 symbol-light mr-1">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('tadmin/media/svg/misc/006-plurk.svg') }}"
                                                                class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="pl-0 py-4">
                                                    <div class="symbol symbol-50 symbol-light">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('tadmin/media/svg/misc/015-telegram.svg') }}"
                                                                class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                </td>
