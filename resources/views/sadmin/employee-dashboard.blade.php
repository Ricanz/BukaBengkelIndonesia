            ...
            <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-header border-0 pt-5">
                    <div class="card-title font-weight-bolder">
                        <div class="card-label">Informasi Data Cabang Employee
                        <div class="font-size-sm text-muted mt-2">30 Total Cabang</div></div>
                    </div>
                        ...
                        <div class="row row-paddingless mt-5 mb-10">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="font-size-h4 text-dark-75 font-weight-bolder">287</div>
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Standart Checking</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="font-size-h4 text-dark-75 font-weight-bolder">105</div>
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Complete Checking</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
                        ...
                        <div class="row row-paddingless">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="font-size-h4 text-dark-75 font-weight-bolder">241</div>
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Total Karyawan</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="font-size-h4 text-dark-75 font-weight-bolder">1511</div>
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Total Pelanggan</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Data ringkasan hasil checking</span>
                    </h3>
                    <div class="card-toolbar">
                        <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                            <li class="nav-item">
                                <a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_tab_pane_11_1">Semua</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_tab_pane_11_2">Standart</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_tab_pane_11_3">Complete</a>
                            </li>
                        </ul>
                    </div>
                </div>
