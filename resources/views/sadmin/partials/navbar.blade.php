                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="hover"
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-desc">Master Data Website</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('master/articles') }}" class="menu-link">
                                    ...
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('master/item') }}" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <span class="menu-text">Master Item Checking</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('master/standart') }}" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                ...
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('clients') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Daftar Bengkel</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('access') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Akses Bengkel</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu">
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="hover"
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-desc">Data Users Bukbeng</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('employees?filter=employee') }}" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    ...
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ route('employee.download') }}" target="blank" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <span class="menu-text">Download Users</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('advisor') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Service Advisor</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu">
                                        <a href="{{ url('employees?filter=employee') }}" class="menu-link">
